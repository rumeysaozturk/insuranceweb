		...
		<div class="col-lg-12 col-md-12 col-xs-12">
			<div class="row">
				<div class="kayıt" style="text-align: center;">
					<h2 class="baslik">Kişi Bilgileri</h2>
					<form th:action="@{/updateUser}" th:object="${user}" method="POST">
						...
						<br> <input class="bilgi" type="text" th:field="*{tc}"
							name="tc" required minlength="11" maxlength="11" /><br>
						<div style="margin-left: 83px; font-weight: bolder; float: left;">Telefon
							Numarası:</div>
						<br> <input class="bilgi" type="tel"
							th:field="*{phoneNumber}" name="phoneNumber" required minlength="11" maxlength="11" /><br>
