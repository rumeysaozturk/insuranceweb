		...
		<div class="col-lg-12 col-md-12 col-xs-12">
			<div class="row">
				<div class="kayıt" style="text-align: center;">
					<h3 class="baslik">SİGORTA KAYIT SİSTEMİ</h3>
					<input type="button" class="btn btn-primary"
						onclick="location.href='kullanıcı';" value="KULLANICI KAYDI" /> <br>
					<br> <input type="button" class="btn btn-primary"
						onclick="location.href='araba';" value="ARABA KAYDI" /><br>
					<br> <input type="button" class="btn btn-primary"
						onclick="location.href='house';" value="KONUT KAYDI" /> <br>
					<br>
					<br>
					<br>
				</div>
