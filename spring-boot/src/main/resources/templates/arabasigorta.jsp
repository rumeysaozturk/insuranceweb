		...
		<div class="col-lg-12 col-md-12 col-xs-12">
			<div class="row">
				<div class="kayıt" style="text-align: center;">
					<h2 class="baslik">Araba Sigortası</h2>
					<form th:action="@{/addCarInsurance}" th:object="${arabaSigorta}" method="post">

						<div style="margin-left: 83px; font-weight: bolder; float: left;">Tc Kimlik Numarası:</div>
						<br> <input class="bilgi " type="text"
							name="tc" required maxlength="50" /><br>

						<div style="margin-left: 83px; font-weight: bolder; float: left;">Plaka:</div>
						<br> <input class="bilgi" type="text" name="plaque" required
							maxlength="50" /><br>
